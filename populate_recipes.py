...
def populate():
    ...
    ingredients = [
                   ...
                   {'rawFood': 'tomato', 'amount' : 'a couple', 'recipe': 'Burger', 'unit':'blank'},
                   {'rawFood': 'beef burger', 'amount' : '200', 'recipe': 'Burger', 'unit':'gram'},
                   {'rawFood': 'bread bun', 'amount' : '1', 'recipe': 'Burger', 'unit':'blank'},
                   ...
                   {'rawFood': 'double cream', 'amount' : '300', 'recipe': 'Chocolate mousse', 'unit':'millilitre'},
                   {'rawFood': 'dark chocolate', 'amount' : '200', 'recipe': 'Chocolate mousse', 'unit':'gram'},
                   {'rawFood': 'egg', 'amount' : '4', 'recipe': 'Chocolate mousse', 'unit':'blank'},
                   {'rawFood': 'caster sugar', 'amount' : '100', 'recipe': 'Chocolate mousse', 'unit':'gram'},
                   {'rawFood': 'egg', 'amount' : '2', 'recipe': 'Choc chip cookies', 'unit':'blank'},
                   {'rawFood': 'caster sugar', 'amount' : '300', 'recipe': 'Choc chip cookies', 'unit':'gram'},
                   {'rawFood': 'butter', 'amount' : '300', 'recipe': 'Choc chip cookies', 'unit':'gram'},
                   {'rawFood': 'plain flour', 'amount' : '300', 'recipe': 'Choc chip cookies', 'unit':'gram'},
                   {'rawFood': 'chocolate chips', 'amount' : '150', 'recipe': 'Choc chip cookies', 'unit':'gram'},
                   {'rawFood': 'apple', 'amount' : '400', 'recipe': 'Apple crumble', 'unit':'gram'},
                   {'rawFood': 'rolled oats', 'amount' : '150', 'recipe': 'Apple crumble', 'unit':'gram'},
                   {'rawFood': 'butter', 'amount' : '75', 'recipe': 'Apple crumble', 'unit':'gram'},
                   {'rawFood': 'caster sugar', 'amount' : '50', 'recipe': 'Apple crumble', 'unit':'gram'},
                   {'rawFood': 'egg', 'amount' : '4', 'recipe': 'Chocolate torte', 'unit':'blank'},
                   {'rawFood': 'caster sugar', 'amount' : '200', 'recipe': 'Chocolate torte', 'unit':'gram'},
                   {'rawFood': 'butter', 'amount' : '100', 'recipe': 'Chocolate torte', 'unit':'gram'},
                   {'rawFood': 'ground almonds', 'amount' : '300', 'recipe': 'Chocolate torte', 'unit':'gram'},
                   {'rawFood': 'chocolate', 'amount' : '200', 'recipe': 'Chocolate torte', 'unit':'gram'},
                   {'rawFood': 'butter', 'amount' : '225', 'recipe': 'Sponge cake', 'unit':'gram'},
                   {'rawFood': 'caster sugar', 'amount' : '225', 'recipe': 'Sponge cake', 'unit':'gram'},
                   {'rawFood': 'plain flour', 'amount' : '225', 'recipe': 'Sponge cake', 'unit':'gram'},
                   {'rawFood': 'egg', 'amount' : '4', 'recipe': 'Sponge cake', 'unit':'blank'},
                   {'rawFood': 'vanilla extract', 'amount' : 'a few', 'recipe': 'Sponge cake', 'unit':'drop'},
                   {'rawFood': 'baking powder', 'amount' : '2', 'recipe': 'Sponge cake', 'unit':'teaspoon'}]
    ...
    recipes = [
               ...
               {'name': 'Pizza', 'categories': ['main','lunch','dinner','medium','vegetarian'], 'rating': 3.5,
                ...
                {'name': 'Chocolate mousse', 'categories': ['dessert','hard','vegetarian'], 'rating': 2.0,
                'difficulty': 4.0, 'time': 80.0, 'imagePath': 'recipes/ChocolateMousse/chocolateMousse.png'},
                {'name': 'Choc chip cookies', 'categories': ['dessert','snack','vegetarian','easy','quick'], 'rating': 5.0,
                'difficulty': 1.5, 'time': 25.0, 'imagePath': 'recipes/ChocChipCookies/chocChipCookies.png'},
                {'name': 'Apple crumble', 'categories': ['dessert','vegetarian','easy'], 'rating': 4.5,
                'difficulty': 2.0, 'time': 45.0, 'imagePath': 'recipes/AppleCrumble/appleCrumble.png'},
                {'name': 'Chocolate torte', 'categories': ['dessert','vegetarian','medium'], 'rating': 2.5,
                'difficulty': 3.0, 'time': 60.0, 'imagePath': 'recipes/ChocolateTorte/chocolateTorte.png'},
                {'name': 'Sponge cake', 'categories': ['dessert','vegetarian','medium'], 'rating': 3.5,
                'difficulty': 3.5, 'time': 60.0, 'imagePath': 'recipes/SpongeCake/spongeCake.png'}]
    ...
    instructions = [
                    ...
                    {'step': 2, 'recipe': 'Stir fry', 'media': None, 'description': 'Fry with peas and sprouts.'},
                    {'step': 3, 'recipe': 'Stir fry', 'media': None, 'description': 'Boil noodles for 3 minutes.'},
                    {'step': 4, 'recipe': 'Stir fry', 'media': None, 'description': 'Add  noodles and sauce to the vegetables.'},
                    {'step': 1, 'recipe': 'Chocolate mousse', 'media': None, 'description': 'Split the eggs and whisk the egg whites.'},
                    {'step': 2, 'recipe': 'Chocolate mousse', 'media': None, 'description': 'Melt the chocolate in a pan and then mix in the cream.'},
                    {'step': 3, 'recipe': 'Chocolate mousse', 'media': None, 'description': 'Add sugar and the egg yolks to the chocolate and cream.'},
                    {'step': 4, 'recipe': 'Chocolate mousse', 'media': None, 'description': 'Fold in egg whites.'},
                    {'step': 5, 'recipe': 'Chocolate mousse', 'media': None, 'description': 'Leave to set in the fridge for 1 hour.'},
                    {'step': 1, 'recipe': 'Choc chip cookies', 'media': None, 'description': 'Preheat the oven to 160 degrees Celsius.'},
                    {'step': 2, 'recipe': 'Choc chip cookies', 'media': None, 'description': 'Mix the butter and sugar.'},
                    {'step': 3, 'recipe': 'Choc chip cookies', 'media': None, 'description': 'Add the eggs and flour.'},
                    {'step': 4, 'recipe': 'Choc chip cookies', 'media': None, 'description': 'Mix in the chocolate chips.'},
                    {'step': 5, 'recipe': 'Choc chip cookies', 'media': None, 'description': 'Roll into balls and place on a baking sheet.'},
                    {'step': 6, 'recipe': 'Choc chip cookies', 'media': None, 'description': 'Bake for 15 minutes.'},
                    {'step': 1, 'recipe': 'Apple crumble', 'media': None, 'description': 'Preheat the oven to 190 degrees Celsius.'},
                    {'step': 2, 'recipe': 'Apple crumble', 'media': None, 'description': 'Chop and core the apples.'},
                    {'step': 3, 'recipe': 'Apple crumble', 'media': None, 'description': 'Rub the butter into the oats and sugar.'},
                    {'step': 4, 'recipe': 'Apple crumble', 'media': None, 'description': 'Put apples in a baking dish and spread oat mix out on top.'},
                    {'step': 5, 'recipe': 'Apple crumble', 'media': None, 'description': 'Bake for 30 minutes.'},
                    {'step': 1, 'recipe': 'Chocolate torte', 'media': None, 'description': 'Preheat oven to 180 degrees Celsius.'},
                    {'step': 2, 'recipe': 'Chocolate torte', 'media': None, 'description': 'Melt the chocolate and butter in a pan.'},
                    {'step': 3, 'recipe': 'Chocolate torte', 'media': None, 'description': 'Blend all other ingredients together.'},
                    {'step': 4, 'recipe': 'Chocolate torte', 'media': None, 'description': 'Add the chocolate and butter to the mix.'},
                    {'step': 5, 'recipe': 'Sponge cake', 'media': None, 'description': 'Bake in a tray for 45 minutes.'},
                    {'step': 1, 'recipe': 'Sponge cake', 'media': None, 'description': 'Preheat oven to 180 degrees Celsius.'},
                    {'step': 2, 'recipe': 'Sponge cake', 'media': None, 'description': 'Mix the cream, butter and sugar together.'},
                    {'step': 3, 'recipe': 'Sponge cake', 'media': None, 'description': 'Add eggs and vanilla.'},
                    {'step': 4, 'recipe': 'Sponge cake', 'media': None, 'description': 'Fold in flour and baking powder.'},
                    {'step': 5, 'recipe': 'Sponge cake', 'media': None, 'description': 'Pour into a baking tin.'},
                    {'step': 6, 'recipe': 'Sponge cake', 'media': None, 'description': 'Bake for 40 minutes.'}]
